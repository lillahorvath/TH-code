classdef th_agentobj_BB_R_1
    ...
    % methods of agent variant BB-R-1
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    methods
        
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        function agentobj = th_agentobj_BB_R_1(agent_init)

        % This function creates an agent object of class th_agentobj_BB_R_1 
        ...
        % based on the maximum a posteriori target location to evaluate the 
        % action valences
        %
        % Inputs
        ...
        % action-outcome node and the maximum-a-posteriori belief
        % -----------------------------------------------------------------
        [~,map_n] = max(round(agentobj.B(:,end), 10));                      % maximum a posteriori node
